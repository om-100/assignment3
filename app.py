...
def course_select():
    course = int(input('''
    Enter the couser you want to select: 
    [Choose]  '''))
...
def course_inquiry():
    id = int(input('''
    *****************Choose Course For Details**************

    1. Input 1 for Python Details
    2. Press 2 for JavaScript Details
    3. Press 3 for django Details
    4. Press 4 for Java Details
    5. Press 5 for Php Details
    6. Press 6 to get all subject details
...
def my_app(choice):
    ...
    print(b.get(choice, "Invalid Input"))
    if choice == 1:
        course_inquiry()
    elif choice == 2:
